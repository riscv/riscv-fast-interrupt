...
To ensure that cspspush can differentiate the stack pointers,
bit 2 is asserted when storing the stack pointer.

Behavior::

[source]
----
if (xsp != 0) and (xsp.SWAP == 0) and (xstatus.XPP == xsp.MODE)
