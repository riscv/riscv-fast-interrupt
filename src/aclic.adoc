...
----
mithreshold
 8          mien        Alias of ~mstatus.mie
 7:0        iprio[7:0]  Interrupt-enable threshold
----

The field {mithreshold}.{iprio} implements exactly IPRIOLEN bits.
...
mistatus
 ...
 15:8       pithreshprio[7:0] Previous mithreshold.iprio value
...
sistatus
 ...
 25:20      (reserved)
 19:18      VS[1:0]           Vector extension status, mirror of sstatus.VS
 17:16      FS[1:0]           Floating-point extension status, mirror of sstatus.FS
 15:8       pithreshprio[7:0] Previous sithreshold.iprio value
...
----
sithreshold
 8          sien        Alias of ~sstatus.sie
 7:0        iprio[7:0]  Interrupt-enable threshold
----

The field {sithreshold}.{iprio} implements exactly IPRIOLEN bits.

When reading from {stopi} or {stopei}, and no interrupt is pending and enabled at supervisor level,
...
When {xithreshold}.{iprio} is a nonzero value,
...
When {xithreshold}.{iprio} is zero,
