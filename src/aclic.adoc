...
Faults that occur during the read of interrupt jump table entries are not recoverable.
If a load page fault can occur during the interrupt jump table read,
