...
If {xfie} is one, interrupts are enabled and can cause a trap irrespective of {xie},
if they are considered fast interrupts as per configuration of `FITHRESHOLD`.
