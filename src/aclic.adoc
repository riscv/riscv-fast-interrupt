...
No change of stack pointer occurs for the cspspush and cspspop instructions in the nested handler.
...
Values other than 0 in the low 6 bits of {xeivt} are reserved.
