...
and integrates the subset of Advanced Platform Level Interrupt Controller (APLIC) functionality into a hart-local interrupt controller.
...
. Hart-local APLIC domains including direct delivery of interrupts to the hart (Non-ISA)
