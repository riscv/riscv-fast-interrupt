...
[source]
----
Mode  Event            msp.PUSH  msp.PPUSH  sp-wap?
S     -                1         X          n
M     trap             1         X          n
M     cspspush         0         1          y
...
The stack pinter is swapped when changing from S-mode to M-mode,
...
[source]
----
xsp.PPUSH = xsp.PUSH         /* Latch the push bit into the previous push bit */
