...
the {IPRIO} field returns {mithreshold}.

NOTE: Returning mithreshold as {IPRIO} field allows software to use this priority as threshold for spurious interrupts handlers.
...
have_handler:
    csrw    CSR_MITHRESHOLD, t0

    csrsi   mstatus, MSTATUS_MIE
    jalr    t3
    csrci   mstatus, MSTATUS_MIE

    csrw    CSR_MITHRESHOLD, s1
    csrsi   CSR_MISTATUS, 1
