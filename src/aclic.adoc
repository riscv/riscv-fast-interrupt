...
| a1 | 1 | 0 | 0
| a2 | `xtval` | No Write | No Write
| a3 | `xtval2` | No Write | No Write
| a4 | `xtinst` | No Write | No Write
|===
+
...
+
The value in a1 can be used to distinguish synchronous exceptions from interrupts in shared handlers.
+
