...
Endianess is controlled exclusively by the setting in the {xstatus} register at the hart.
...
The Smictrl and Ssictrl extensions depend on Smaia and Ssaia, respectively.
