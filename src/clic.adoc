...
Synchronous exceptions are vectored using xtvec as an offset.
...
NOTE: Accelerating synchronous exception handlers through vectoring positively affects interrupt latency.
During synchronous exceptions, interrupts are disabled.
Acceleration of this critical segment decreases the time the interrupts are masked.
