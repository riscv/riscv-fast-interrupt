...
== Smcsps Conditional Stack Pointer Swap extension
...
==== Conditional stack pointer swap (push mode) cspspush
...
==== Conditional stack pointer swap (pop mode) cspspop
...
== Sscsps Conditional Stack Pointer Swap extension
...
* Conditionally performs a stack pointer swap by executing xcsps
