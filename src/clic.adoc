...
{reg: [
  ...
  {bits: 3, name: 0x4, attr: [''], type: 8},
  {bits: 5, name: 0x2, attr: ['rs'], type: 4},
  {bits: 12, name: 0x500, attr: [''], type: 8},
]}
....
...
{reg: [
  ...
  {bits: 3, name: 0x4, attr: [''], type: 8},
  {bits: 5, name: 0x2, attr: ['rs'], type: 4},
  {bits: 12, name: 0x700, attr: [''], type: 8},
]}
....
...
{reg: [
  {bits: 7, name: 0x73, attr: ['SYSTEM'], type: 8},
  {bits: 5, name: 0x0, attr: ['reserved'], type: 2},
  {bits: 3, name: 0x4, attr: [''], type: 8},
  {bits: 5, name: 0x0, attr: ['reserved'], type: 4},
  {bits: 1, name: 'imm1', attr: ['preempt'], type: 3},
  {bits: 11, name: 0x80, attr: [''], type: 8},
]}
....
...
{reg: [
  ...
  {bits: 3, name: 0x4, attr: [''], type: 8},
  {bits: 5, name: 0x0, attr: ['reserved'], type: 4},
  {bits: 12, name: 0x300, attr: [''], type: 8},
]}
....
