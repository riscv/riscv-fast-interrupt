...
#TODO: repurpose conditional scratch swap registers to xsp and xtsp
...
After a trap, the xcspw instruction will swap the previous sp with the value in xtsp if {insert CSR here}.xtspsw is asserted.

=== xcspsw

The xcspsw instruction conditional swaps the sp register with the xsp or xtsp register.
