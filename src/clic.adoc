...
bit 53 of sstateen0 controls less-privileged access to to {vspintstatus}.
...
Anologously, if Sstateen is implemented,
bit 53 of sstateen0 controls less-privileged access to to {vsivt}.
...
Anologously, if Sstateen is implemented,
bit 53 of sstateen0 controls less-privileged access to to {vssp}.
