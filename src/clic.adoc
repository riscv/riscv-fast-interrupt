...
NOTE: The number of aliased bits depends on MXLEN and if AIA is implemented.
Only for MXLEN=32 and without AIA is mip 32b wide, else 64b
...
NOTE: The number of aliased bits depends on MXLEN and if AIA is implemented.
Only for MXLEN=32 and without AIA is mie 32b wide, else 64b
