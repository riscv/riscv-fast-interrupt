...
The Smclic extension depends on the Smclicincr extension.
...
{mintstatus}.{mipprio} and {mpintstatus}.{mpipprio} fields reset to the highest possible value.
...
In CLIC mode, {ret} sets {mintstatus}.{mipprio} to {mpintstatus}.{mpipprio}.
