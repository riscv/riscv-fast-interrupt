...
----
 ...
 offset    |     bits      |  register state             |                    |
  ...
  0x0      |     31:0     |   R or RW   clicintip[31:0]  |  clic interrupt pending for interrupts 31-0 |
  0x1      |     31:0     |   R or RW   clicintip[63:32] |  clic interrupt pending for interrupts 63:32|
 ...
  0x7F     |     31:0     |   R or RW   clicintip[4095:4064] |  clic interrupt pending for interrupts 4095-4064  |
----

----
 miselect  |     mireg2    |  mireg2                     |     description    |
 offset    |     bits      |  register state             |                    |

  0x0      |     31:0     |   R or RW   clicintie[31:0]  |  clic interrupt enable for interrupts 31-0 |
  0x1      |     31:0     |   R or RW   clicintie[63:32] |  clic interrupt enable for interrupts 63:32|
 ...
  0x7F     |     31:0     |   R or RW   clicintie[4095:4064] |  clic interrupt enable for interrupts 4095-4064  |
----

----
 miselect  |     mireg3    |  mireg3                     |     description    |
 offset    |     bits      |  register state             |                    |

  0x0      |     31:0     |   RW   clicinttrig[0]  |  clic interrupt trigger 0 |
  0x0 + i  |     31:0     |   RW   clicinttrig[i]  |  clic interrupt trigger i |
...
  0x1F     |     31:0     |   RW   clicinttrig[31] |  clic interrupt trigger 31|
----

----
 miselect  |     mireg4    |  mireg4                     |    
 offset    |     bits      |  register state             |    
  0x0      |     31:0     |   reserved for smclicconfig extension |
----

----
 miselect  |     mireg     |  mireg                         |    description                                       |
 offset    |     bits      |  register state                |                                                      |
  0x80+i   |      7:0      |     RW  clicintctrl[i x 4]     |  clic level/priority setting for interrupt i x 4     | 
  0x80+i   |      15:8     |     RW  clicintctrl[i x 4 + 1] |  clic level/priority setting for interrupt i x 4 + 1 |    
  0x80+i   |      23:16    |     RW  clicintctrl[i x 4 + 2] |  clic level/priority setting for interrupt i x 4 + 1 |    
  0x80+i   |      31:24    |     RW  clicintctrl[i x 4 + 3] |  clic level/priority setting for interrupt i x 4 + 1 |    
---
----
 miselect  |     mireg2     |  mireg2                       |    description                                  |
 offset    |     bits      |  register state                |                                                 |
  0x80+i   |      7:0      |     RW  clicintattr[i x 4]     |  clic attribute setting for interrupt i x 4     | 
  0x80+i   |      15:8     |     RW  clicintattr[i x 4 + 1] |  clic attribute setting for interrupt i x 4 + 1 |    
  0x80+i   |      23:16    |     RW  clicintattr[i x 4 + 2] |  clic attribute setting for interrupt i x 4 + 1 |    
  0x80+i   |      31:24    |     RW  clicintattr[i x 4 + 3] |  clic attribute setting for interrupt i x 4 + 1 |    
---
...
----
 siselect  |     sireg2    |  sireg2                     |     description    |
 offset    |     bits      |  register state             |                    |
...
----
 siselect  |     sireg4    |  sireg4                     |    
 offset    |     bits      |  register state             |    
  0x0      |     31:0     |   reserved for ssclicconfig extension |
----
...
`clicintip[__i__]!=0` indicates an interrupt is pending.
...
Software should assume clicintie[i]=0 means no interrupt enabled, and clicintie[i]!=0 indicates an interrupt is enabled.
