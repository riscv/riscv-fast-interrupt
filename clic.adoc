...
:revdate: 09/16/2021
:revnumber: 0.9
:revremark: This document is in the Development state. Assume anything can change.
...
The `clicintattr.mode` field is reset to 11 (i.e., machine mode). 
