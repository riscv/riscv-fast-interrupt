...
existing {tvec} WARL register, where {tvec}.`mode` (the
least-significant six bits) is `000011`.  In this mode, the trap
vector base address held in {tvec} is constrained to be aligned on a
