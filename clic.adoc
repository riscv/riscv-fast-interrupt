...
08/30/2022  issue #219 - csip interrupt ordering clarification
...
=== CLIC-mode interrupt-map recommendation for systems with PLIC/APLIC:
...
=== CLIC-mode interrupt-map recommendation for M/S/U systems without N extension with no PLIC/APLIC:
...
=== CLIC-mode interrupt-map recommendation for M-mode only or M/U mode
