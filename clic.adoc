...
or all privilege modes must run in non-CLIC mode.  Only M-mode can select CLIC versus non-CLIC mode.  Lower privilege modes do not have the ability to change between CLIC and non-CLIC modes. 

----
         Action on Interrupt
  xtvec (when mtvec.mode != 11)        
