...
----
 ...
 offset    |  bits  |  register state            |  bits   |  register state            |                                  |
  0x80+i   |  7:0   | RW  clicintctrl[i x 4]     |   7:0   | RW  clicintattr[i x 4]     |  setting for interrupt i x 4     | 
  0x80+i   | 15:8   | RW  clicintctrl[i x 4 + 1] |  15:8   | RW  clicintattr[i x 4 + 1] |  setting for interrupt i x 4 + 1 |    
  0x80+i   | 23:16  | RW  clicintctrl[i x 4 + 2] |  23:16  | RW  clicintattr[i x 4 + 2] |  setting for interrupt i x 4 + 2 |    
  0x80+i   | 31:24  | RW  clicintctrl[i x 4 + 3] |  31:24  | RW  clicintattr[i x 4 + 3] |  setting for interrupt i x 4 + 3 |    
----
