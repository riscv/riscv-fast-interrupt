...
is defined to support conditional swapping of the {scratch} register
when transitioning between privilege modes.  Though designed to be
used with `csrrw` instructions, this CSR can be accessed with any CSR
instruction.
